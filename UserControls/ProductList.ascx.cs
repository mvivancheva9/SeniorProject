...
public partial class UserControls_ProductList : System.Web.UI.UserControl
{
    ...
    private void PopulateControls()
    {
        ...
        if (categoryId != null)
        {
            ...
            firstPageUrl = Link.ToCategory(brandId, categoryId, "1");
            pagerFormat = Link.ToCategory(brandId, categoryId, "{0}");
        }
        else if (brandId != null)
        {
            ...
            list.DataBind();
            // get first page url and pager format
            firstPageUrl = Link.ToBrand(brandId, "1");
            pagerFormat = Link.ToBrand(brandId, "{0}");
        }
        else
        {
