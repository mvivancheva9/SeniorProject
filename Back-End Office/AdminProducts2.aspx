<%@ Page Title="" Language="C#" MasterPageFile="~/Back-End Office/BackEnd.master" AutoEventWireup="true" CodeFile="AdminProducts2.aspx.cs" Inherits="Back_End_Office_AdminProducts2" %>
...
<ItemStyle Height="110px" Width="75px"></ItemStyle>
      ...
      <asp:TemplateField>
        <ItemTemplate>
          <asp:HyperLink 
            ...
            NavigateUrl='<%# "AdminProductDetails2.aspx?BrandID=" + 
            Request.QueryString["BrandID"] + "&amp;CollectionID=" + 
            Request.QueryString["CollectionID"] + "&amp;ProductID=" + 
            Eval("ProductID") %>'
            ID="HyperLink1">
          </asp:HyperLink>
        </ItemTemplate>
  ...
  <tr>
  <td>&nbsp</td>
  <th>Създай нов продукт към колекция:</th>
  </tr>
  <tr>
  <th>Име:</th>
  ...
  <tr>
  <th>Малка Снимка:</th>
  <td><asp:TextBox ID="newThumbnail" runat="server" Width="400px">Generic1.jpg</asp:TextBox></td>
   </tr>
  <tr>
  <th>Голяма Снимка:</th>
  <td><asp:TextBox ID="newImage" runat="server" Width="400px">Generic2.jpg</asp:TextBox></td>
