<%@ Page Title="" Language="C#" MasterPageFile="~/Back-End Office/BackEnd.master" AutoEventWireup="true" CodeFile="AdminActivityDetails.aspx.cs" Inherits="Back_End_Office_AdminActivityDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="adminPlaceHolder" runat="Server">
  <asp:Label CssClass="AdminTitle" ID="activityNameLabel" runat="server" />  
  <p>
  ...
  <td><asp:Label ID="leisureLabel" runat="server" /></td>
  </tr>
  <tr>
  <th>Премахни продукта от тази категория:</th>
   <td> 
    <asp:DropDownList ID="leisureListRemove" runat="server" />  
