...
public partial class Back_End_Office_AdminFashion : System.Web.UI.Page
{
    ...
    {
        // Get a DataTable object containing the catalog fashions
        grid.DataSource = CatalogAccess.GetFashion();
    ...
    protected void grid_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        bool success = CatalogAccess.UpdateFashion(id, name, description);
        // Cancel edit mode
        grid.EditIndex = -1;
    ...
    protected void grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        bool success = CatalogAccess.DeleteFashion(id);
        // Cancel edit mode
        grid.EditIndex = -1;
        // Display status message
    ...
    protected void createFashion_Click(object sender, EventArgs e)
    {
        // Execute the insert command
        bool success = CatalogAccess.AddFashion(newName.Text, newDescription.Text);
        // Display status message
