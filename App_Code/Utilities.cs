...
public static class Utilities
{
    ...
    string body)
    {
        ...
        SmtpClient mailClient = new SmtpClient(SPConfiguration.MailServer);
        // Set credentials (for SMTP servers that require authentication)
        mailClient.Credentials = new NetworkCredential(SPConfiguration.MailUsername, SPConfiguration.MailPassword);
    ...
    public static void LogError(Exception ex)
    {
        ...
        if (SPConfiguration.EnableErrorLogEmail)
        {
            string from = SPConfiguration.MailFrom;
            string to = SPConfiguration.ErrorLogEmail;
            string subject = "SP Error Report";
